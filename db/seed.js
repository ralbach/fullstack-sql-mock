...
const insertMockData = function() {
  ...
  for(let i = 0; i < products.length; i++){
    let queryStr = `INSERT INTO products(item, min_cost, curr_bid, ends_in, image) VALUES ("${products[i].item}", ${products[i].min_cost}, ${products[i].curr_bid}, ${products[i].ends_in}, "${products[i].image}");`;
